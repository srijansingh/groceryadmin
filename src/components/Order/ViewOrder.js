                        ...
                        </TableContainer>
                    {
                        ...
                        <Paper elevation={1} style={{width:'700px'}}>
...

                            {
                                ...
                                <Paper style={{margin:'1rem',padding:'0 1rem',height:'50px',  display:'flex',alignItems:'center', justifyContent:'space-around'}}>
                                <Typography>
                                    Note : You cannot change the status when status is <span style={{fontWeight:'bold'}}>Delivered</span>
