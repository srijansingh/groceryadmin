        ...
        const category = slice.map((item, index) => {
            return (
                ...
                <TableRow key={index}>
                    ...
                    <TableCell>
                        <Button variant="contained"size="small" color="primary" startIcon={<VisibilityIcon/>} href={'/category/'+item.category}>View</Button>
                    </TableCell>
                </TableRow>
            )
        })
...
export default  withStyles(styles, {withThemes: true})(ViewBrand);